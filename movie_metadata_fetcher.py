...
with open('movie_titles.csv', mode='r', encoding='utf-8') as file:
    ...
    with open('movie_metadata.csv', mode='w', newline='', encoding='utf-8') as outfile:
        ...
        headers = ["Title", "Year", "Genre 1", "Genre 2", "Genre 3", "Director", "IMDB Rating", "Rotten Tomatoes Rating", "Metacritic Rating", "Rated", "Released", "Runtime", "Writer", "Actor 1", "Actor 2", "Actor 3", "Actor 4", "Plot", "Language", "Country", "Awards", "Poster", "Metascore", "imdbRating", "imdbVotes", "imdbID", "Type", "DVD", "BoxOffice", "Production", "Website", "Response"]
        ...
        for index, row in enumerate(csv_reader):
            if index < 10:  # Limit to the first 100 entries after the first row
                ...
                break  # Stop processing after the first 100 entries
